...
namespace LinkedJazz.View
{
    ...
    /// </summary>
    public sealed partial class SearchArtistView : LinkedJazz.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            this.searchViewModel.QueryText = queryText;
        ...
        /// </summary>
        private sealed class Filter : LinkedJazz.Common.BindableBase
        {
            ...
            {
                get { return _count; }
                set { if (this.SetProperty(ref _count, value)) this.OnPropertyChanged("Count"); }
            }
